...
export default function Profile() {
  ...
  return (
    <ScrollView contentContainerStyle={tw`bg-white pb-8`}>
      {/* Header */}
      <Text style={tw`text-green-700 text-lg font-bold text-center mt-4`}>
        Profile
      </Text>
      ...
      <View style={tw`items-center mt-4`}>
        ...
        />
        <Text style={tw`text-lg font-semibold mt-2`}>Emmie Watson</Text>
        <Text style={tw`text-gray-500`}>emmie1709@gmail.com</Text>
      </View>

      {/* My Account */}
      <View style={tw`bg-white m-4 p-4 rounded-lg border border-gray-200`}>
        <Text style={tw`text-yellow-600 font-semibold mb-3`}>My Account</Text>
      ...
      {/* Notifications */}
      <View style={tw`bg-white m-4 p-4 rounded-lg border border-gray-200`}>
        <Text style={tw`text-yellow-600 font-semibold mb-3`}>Notifications</Text>
      ...
      {/* More */}
      <View style={tw`bg-white m-4 p-4 rounded-lg border border-gray-200`}>
        <Text style={tw`text-yellow-600 font-semibold mb-3`}>More</Text>
